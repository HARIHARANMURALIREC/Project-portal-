...
interface TeacherDashboardLayoutProps {
  ...
  batchId?: string | null
  /** When true, shows a "Switch to Coordinator View" button in the sidebar */
  showCoordinatorSwitch?: boolean
  onSignOut: () => void
    ...
    <>
      ...
      <div className={`border-t border-slate-200 dark:border-slate-700 ${collapsed ? 'p-2' : 'p-4'}`}>
        ...
        {showCoordinatorSwitch && (
          <button
            type="button"
            title="Switch to Coordinator View"
            onClick={() => {
              onNavigate?.()
    ...
    <div className="flex min-h-screen bg-white dark:bg-app-black">
      ...
      >
        <SidebarContent
          ...
          batchId={batchId}
          showCoordinatorSwitch={showCoordinatorSwitch}
          onSignOut={onSignOut}
          collapsed={collapsed}
