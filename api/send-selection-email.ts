...
import { processSelectionEmailForTeam } from '../scripts/lib/processSelectionEmail.ts'
import { brevoConfigFromEnv } from '../scripts/lib/selectionEmail.ts'
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  const result = await processSelectionEmailForTeam(admin, teamId, brevo)
